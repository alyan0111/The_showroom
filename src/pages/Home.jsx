        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="bg-[#0d0d3b] border border-[#00f5ff]/10 rounded-xl h-64 animate-pulse" />
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredCars.map((car) => (
              <CarCard key={car.car_id} car={car} variant="featured" />
            ))}
          </div>
        )}
      </section>
      ...
      <section className="bg-[#05051a] py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {reasons.map((r) => (
              <div key={r.title} className="text-center p-6 border border-[#7b2ff7]/30 rounded-xl hover:border-[#ff2d9b]/50 transition">
